...
<head>
    ...
    <title>Admin Panel - Destinations</title>
...
<body class="bg-light">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="text-end mb-4">
                            <button type="button" class="btn btn-dark shadow-non btn-sm" data-bs-toggle="modal" data-bs-target="#add-destination">
                                <i class="bi bi-plus-square" style="margin-right: 2px;"></i>Add
                            </button>
                        </div>
    ...
    <div class="modal fade" id="add-destination" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form id="add_destination_form" autocomplete="off">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="duration" min="1" type="number" class="form-control shadow-none" required>
                            </div>
                            <div class="col-md-6 mb-3">
    ...
    <div class="modal fade" id="edit-destination" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form id="edit_destination_form" autocomplete="off">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <!-- MANAGE DESTINATION IMAGES MODAL -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close shadown-none" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="border-bottom border-3 pb-3 mb-3">
                        <form id="add_image_form">
                            ...
                            <input name="image" type="file" accept=".jpg, .png, .webp, .jpeg" class="form-control shadow-none mb-3" required>
                    ...
                    <div class="table-responsive-lg" style="height: 350px; overflow-y: scroll;">
                        <table class="table table-hover border text-center">
                            ...
                            <tbody id="destination-image-data">
