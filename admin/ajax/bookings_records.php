...
if (isset($_POST['get_bookings'])) {
    ...
    $lmit_res = select($limit_query, ["%$frm_data[search]%", "%$frm_data[search]%", "%$frm_data[search]%"], "sss");
    ...
    while($data = mysqli_fetch_assoc($lmit_res)){
        ...
        $table_data .="
            <tr>
                ...
                <td>
                    <span class='badge $status_bg fs-5'>$data[booking_status]</span>
                </td>
                <td>
